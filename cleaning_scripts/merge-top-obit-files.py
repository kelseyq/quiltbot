...
with open('../intermediate_data/top-obit-items.json', 'r') as new:
    with open('../intermediate_data/top-obit-items-no-full-names.json', 'r') as old:
        ...
        copyfile('../intermediate_data/top-obit-items.json', '../cleaned_quiltdata/older_data/before_merge_top_obits' +
